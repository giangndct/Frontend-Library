...
const OrderUser = ({ userId }) => {
  ...
  return (
    <div className="py-[40px] min-h-[100vh]">
      <div className="inline-flex w-[100%] justify-between px-10 bg-[#F1F6F9] font-mono mb-[10px]">
      ...
      <div className="bg-[#EDF1D6]">
        ...
        <div className="mt-[50px] flex justify-center text-[25px]">
          <p className="font-mono">Giỏ Hàng</p>
        </div>
        <div className="flex justify-end mr-[15px] mt-[20px] font-mono ">
          <p>{orders.length} sản phẩm trong giỏ</p>
        </div>
        <div className="py-[10%] ml-[220px]">
          <table className="border-2 border-[#ccbbbb42] bg-[#395144] shadow-lg shadow-gray-600 font-mono text-[#fff]">
            <thead className="border-2 border-[#ccbbbb42] font-bold text-[10px] md:text-[14px] lg:text-[18px]">
              <tr>
                <th>Tiêu đề</th>
                <th>Giá</th>
                <th>Giờ</th>
                ...
                orders.map((order) => (
                  <tr>
                    ...
                    <th className="w-[14.5%] my-[8px] border-b-8 border-r-2 border-[#ccbbbb42]">
                      <div
                        className="inline-block w-[100%] py-[3px] bg-[#a61b1b] mt-[5px] hover:bg-[#761313] cursor-pointer"
